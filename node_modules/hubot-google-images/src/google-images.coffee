...
imageMe = (msg, query, animated, faces, cb) ->
  ...
  googleCseId = '017175302824182483158%3Akwqk81lnabc' #process.env.HUBOT_GOOGLE_CSE_ID
  if googleCseId
    # Using Google Custom Search API
    googleApiKey = 'AIzaSyCjS1r3Ita4ZrIusrqlQn8VV83ovcW6GvQ' #process.env.HUBOT_GOOGLE_CSE_KEY
    if !googleApiKey
    ...
    msg.http(url)
      ...
      .get() (err, res, body) ->
        ...
        if res.statusCode isnt 200
          msg.send "Bad HTTP response :( #{res.statusCode}\n cx=#{q.cx}, key=#{q.key}, query=#{q.q}, safe=#{q.safe}, fields=#{q.fields}"
          return
